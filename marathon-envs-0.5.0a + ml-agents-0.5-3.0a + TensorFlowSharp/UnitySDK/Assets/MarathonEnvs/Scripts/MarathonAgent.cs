...
namespace MLAgents
{
    public class MarathonAgent : Agent
    {
        ...
        protected List<Action> collectStateList = new List<Action>();
        public bool[] isCollectList;
        ...
        protected float OnTerminateRewardValue = -1f;
        ...
        protected MarathonSpawner marathonSpawner;
        ...
        public void InitCollectFunction()
        {
            collectStateList.Clear();

            collectStateList.Add(() => CollectPosition(0));
            collectStateList.Add(() => CollectPosition(1));
            collectStateList.Add(() => CollectPosition(2));

            collectStateList.Add(() => CollectRotation(0));
            collectStateList.Add(() => CollectRotation(1));
            collectStateList.Add(() => CollectRotation(2));

            collectStateList.Add(() => CollectVelocity(0));
            collectStateList.Add(() => CollectVelocity(1));
            collectStateList.Add(() => CollectVelocity(2));

            collectStateList.Add(() => CollectAngularVelocity(0));
            collectStateList.Add(() => CollectAngularVelocity(1));
            collectStateList.Add(() => CollectAngularVelocity(2));

            collectStateList.Add(() => CollectJointAngle(0));

            collectStateList.Add(() => CollectJointAngularVelocity(0));

            collectStateList.Add(() => CollectJointCollisionSensors(0));

            isCollectList = new bool[collectStateList.Count];
        }
