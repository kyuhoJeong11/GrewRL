...
class Serializable(object):
    ...
    def __setstate__(self, d):
        ...
        #myzip = zip(in_order_args, d["__args"])
        #print("in_order_args : {0}, d[__args] : {1}, myzip : {2}".format(in_order_args, d["__args"], myzip))

        #mydict = dict(myzip , **d["__kwargs"])
        #print("**d[__kwargs] : ", **d["__kwargs"])
        #print("mydict : ", mydict)

        #print("type(self) : ", type(self))
        #out = type(self)(**mydict)
